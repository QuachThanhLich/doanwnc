...
<body>
    ...
    <img src='./img/slideshow_1 (1).webp'>
    </div>
  <div class="d-flex justify-content-center">
      <h6>Mua sắm tại IVY moda thật dễ dàng. Quý khách chỉ cần làm theo các bước sau:</h6>
</div>
    <div style="padding-left: 20%; padding-right: 20%;">
     ...
     <h6> Trong trường hợp quý khách muốn thay đổi địa chỉ giao hàng, số điện thoại hoặc thông tin người nhận cho đơn hàng đã đặt thì:</h6>
     <p>TH1: Nếu đơn hàng chưa được IVY moda xử lý, bạn chỉ cần làm các bước sau:</p>
     <p>Bước 1: Vào đường link</p>
     <p>Bước 2: Điền Mã đơn hàng và Số Điện Thoại đặt đơn</p>
     <p>Bước 3: Bấm vào Hủy đơn</p>
     <p>Bước 4: Đặt lại đơn mới</p>
     <h6>TH2: Nếu đơn hàng đã được IVY moda xử lý thì bạn liên hệ đến: Hotline: 02466623434 - nhánh 3 để được hỗ trợ</h6>
